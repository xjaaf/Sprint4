...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <h1 class="play-text">Let's Edit</h1>

    

    <form method="POST" action="{{ route('teams.update', ['team' => $team->id]) }}" class="max-w-sm mx-auto">
